...
impl DashboardStats {
    ...
    pub fn compute(
        ...
        // Last activity = first non-commute, public activity (API returns newest first)
    ...
    pub fn print_summary(&self) {
        ...
        println!(
            "🏃 YTD Running Distance:  {:.1} km",
            self.ytd_run_distance_km
        );
        println!(
            "🚴 YTD Cycling Distance:  {:.1} km",
            self.ytd_ride_distance_km
        );
        println!();
