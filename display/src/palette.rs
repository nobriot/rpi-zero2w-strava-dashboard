...
/// Find the nearest display color for an RGB pixel using squared Euclidean distance.
...
/// Quantize an RGB image to the 6-color palette and pack into the EPD wire format.
/// Returns a buffer of WIDTH*HEIGHT/2 bytes (2 pixels per byte, high nibble first).
